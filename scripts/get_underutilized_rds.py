"""Find underutilized RDS instances with potential cost savings."""
...
def main():
    parser = argparse.ArgumentParser(description="Find underutilized RDS instances")
